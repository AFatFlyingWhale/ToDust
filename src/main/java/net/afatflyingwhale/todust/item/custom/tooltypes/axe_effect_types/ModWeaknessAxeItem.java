...
public class ModWeaknessAxeItem extends AxeItem {
    public ModWeaknessAxeItem(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Settings settings) {
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        tooltip.add(Text.translatable("Lacerating").formatted(Formatting.RED));
