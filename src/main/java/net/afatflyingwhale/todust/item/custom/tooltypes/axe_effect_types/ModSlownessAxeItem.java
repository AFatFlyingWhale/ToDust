...
public class ModSlownessAxeItem extends AxeItem {
    public ModSlownessAxeItem(ToolMaterial toolMaterial, float attackDamage, float attackSpeed, Settings settings) {
